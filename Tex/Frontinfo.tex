...
\title[基于LoongArch架构的ART执行引擎适配与优化技术研究]{基于LoongArch架构的ART执行引擎\\适配与优化技术研究}% 论文中文题目
\author{鄢玺}% 论文作者
...
%-> 英文封面信息
%-
\TITLE{Research on Adaptation and Optimization of\\ the ART Execution Engine\\ for LoongArch Architecture}% 论文英文题目
\AUTHOR{Yan Xi}% 论文作者
